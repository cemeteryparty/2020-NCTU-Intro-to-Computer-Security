...
}addition; // https://tools.ietf.org/html/rfc6891
...
void format_query_name(unsigned char *query_name){
	//unsigned char dns_record[32] = "cmu.edu."; // 13 times , sometimes failed
	//unsigned char dns_record[32] = "amazon.com."; // 10.4 times
	//unsigned char dns_record[32] = "nasa.gov."; // 44.5 times
	//unsigned char dns_record[32] = "ieee.org."; // 13.9 times
	//unsigned char dns_record[32] = "github.com."; // 10.3 times
	//unsigned char dns_record[32] = "sandia.gov."; // 35.4 times
	unsigned char dns_record[32] = "nctu.edu.tw."; // 29.0 times
	int i,j,beg = 0;
